...
class Transaction:
    ...
    def read_transaction_file(file_path):
        ...
        Skips lines starting with "00" instead of stopping.
        """
        transactions = []
        with open(file_path, 'r') as file:
            for line_num, line in enumerate(file, 1):
                ...
                code = clean_line[0:2]
                name = clean_line[3:22].rstrip("_")
                acctNum = clean_line[23:28]
                amountStr = clean_line[29:37]
